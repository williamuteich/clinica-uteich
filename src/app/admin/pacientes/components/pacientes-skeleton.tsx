export async function PacientesSkeleton() {
    return (
        <div className="flex flex-col gap-8 w-full animate-pulse">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-6">
                ...
                <div className="overflow-hidden rounded-2xl border border-slate-100">
                    <div className="grid grid-cols-5 gap-4 p-4 bg-slate-100 border-b border-slate-200">
                    ...
                    {Array.from({ length: 8 }).map((_, index) => (
                        <div
                            key={index}
                            className="grid grid-cols-5 gap-4 p-4 border-b border-slate-100 last:border-none items-center"
                        >
                            <div className="flex items-center gap-3">

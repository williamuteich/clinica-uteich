...
const QUESTIONS: Question[] = [
    ...
    { id: "depressao", label: "Possui depressão?" },
    ...
    { id: "profilaxia", label: "Já se submeteu à Profilaxia / Prevenção (limpeza, flúor, selante oclusal, etc.)?" },

    // Custom non-yes/no fields
    ...
    { id: "succao_dedo", label: "Realiza(ou) sucção de dedo ou lábio?" },

    {
        id: "sobremordida",
        label: "Qual a sobremordida?",
        type: "select",
        options: [
    ...
    },
    {
        ...
        label: "Qual o trespasse horizontal?",
        type: "select",
        options: [
            { value: "NORMAL", label: "Normal" },
    ...
    { id: "mordida_cruzada", label: "Possui mordida cruzada?" },
    { id: "alteracao_ganglionar", label: "O paciente possiu alguma alteração ganglionar?" },
...
export default function OrthodonticAnamnesis({
    responses,
    onChange,
    queixaPrincipal,
    onQueixaChange,

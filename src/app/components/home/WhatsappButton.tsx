export function WhatsAppButton() {
    ...
    return (
        <a
            ...
            className="hidden md:flex fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] text-white rounded-full items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300"
